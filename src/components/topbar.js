...
const Topbar = (props) => {
  return (
    <div className={`topbar-topbar ${props.rootClassName}`}>
      ...
      <Link to="/admin-business-owner-dashboard" className="topbar-sales-optima-text">
...
Topbar.defaultProps = {
  ...
  rootClassName: '',
  SaleOptimaiconremovebgpreview1_src: '/external/saleoptimaiconremovebgpreview1383-4qea-200h.png',
